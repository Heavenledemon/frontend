...
const ContactUs = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "7a4ce198-8ca3-4600-879d-0e25d36d4a69");
  ...
  return (
    <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      <Title title='Reach out to us' desc='From strategy to excution, we craft digital solutions that move your business forward.' />
      ...
      <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full '>
        ...
        <div>
          ...
          <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
            ...
            <input name='name' type="text" placeholder='Enter your name' className='bg-transparent p-3 text-sm outline-none w-full' required />
          </div>
        </div>
        ...
        <div>
          ...
          <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
            ...
            <input name='email' type="text" placeholder='Enter your email' className='bg-transparent p-3 text-sm outline-none w-full' required />
          </div>
        </div>
